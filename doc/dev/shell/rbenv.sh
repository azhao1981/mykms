...
set -x \
  ...
  && git clone --depth=1 git@gitee.com:azhao-1981/rbenv.git ~/.rbenv \
  && git clone --depth=1 git@gitee.com:azhao-1981/ruby-build.git ~/.rbenv/plugins/ruby-build \
  && git clone --depth=1 git@gitee.com:azhao-1981/rbenv-gemset.git ~/.rbenv/plugins/rbenv-gemset \
  && git clone --depth=1 git@gitee.com:azhao-1981/rbenv-china-mirror.git ~/.rbenv/plugins/rbenv-taobao-mirror \
