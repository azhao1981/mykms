...
| [gitee](https://gitee.com/azhao-1981/the-book-of-secret-knowledge)
...
1、SimpleKernel：一个用来练手的简单内核项目。提供了各个阶段完成度不同的内核，可以选择从自己喜欢的地方开始
...
23、nginx-ui：在线修改 Nginx 配置的服务。总的来说还是能减少修改配置出错的概率，而且不用面对漆黑枯燥的命令行了
好像比原来那 configure好看
https://github.com/schenkd/nginx-ui
26、data-scientist-roadmap：数据科学技能路线图
...
2、ToolGood.Words：一款高性能非法词、敏感词检测库。还支持繁体简体互换、获取拼音首字母、获取拼音字母、拼音模糊搜索等功能
https://github.com/toolgood/ToolGood.Words
3、workflow：搜狗开源的 C++ 服务器引擎。支撑搜狗几乎所有后端 C++ 在线服务，包括所有搜索服务、云输入法、广告等，每日处理超百亿请求。这是一个设计轻盈优雅的企业级程序引擎，可以满足大多数 C++ 后端开发需求
https://github.com/sogou/workflow

4、flexboxfroggy：一个帮助学习 CSS flexbox 知识的在线游戏。游戏一共 24 关，通俗易懂的解释了 flex 布局。适合初学者，并且支持中文，可以在 settings 中选择语言。在线试玩
https://github.com/thomaspark/flexboxfroggy

5、go-diagrams：用 Go 语言画架构图的工具。想画架构图不知道用什么工具？会 Go 的小伙伴可以试试这个库，通过编写 Go 代码来绘制架构图，接口使用方便，但文档太简单了。示例代码：
https://github.com/blushft/go-diagrams

18、asciinema：终端记录工具。忘记录屏软件吧，纯文本的录制终端操作的工具。安装简单、使用方便，且生成的记录文件极小，但需要配合 JS 文件播放
https://github.com/asciinema/asciinema

19、playwright-python：微软开源的浏览器自动化工具，可以用 Python 语言操作浏览器啦。支持 Linux、macOS、Windows 系统下的 Chromium、Firefox 和 WebKit 浏览器
https://github.com/microsoft/playwright-python

21、redis-memory-analyzer：Redis 实时内存分析工具。我比较好奇它是怎么实时获取 redis 中 key 的情况和信息，就看了下源码 scanner.py 文件。发现是采用 scan_iter 方法，控制扫描 key 返回的量。然后通过 yield 减少内存占用量，最后再加上 register_script 方法调用 Lua 脚本或 pipeline 方法提高获取 key 信息的效率。分析后感觉这个工具可适用在数据量较大的情况，实时性要求在秒或者分钟级的场景下
https://github.com/gamenet/redis-memory-analyzer
22、practical-python：大佬 David Beazley 开源的 Python 免费入门级教程。他是《Python Cookbook 第三版》、《Python 参考手册》的作者，教程经过实际的教学实践、包含课后练习题。在线学习，教程目录如下：
https://github.com/dabeaz-course/practical-python
23、stats：macOS 菜单栏上的监控工具。支持 CPU、GPU、内存、网络等监控和多语言
https://github.com/exelban/stats
24、ZY-Player：免费无广告、高颜值+多平台的桌面视频资源播放器。功能如下：
https://github.com/Hunlongyu/ZY-Player
26、tabler-icons：一组免费开源的图标。目前共有 850+ 个图标，我觉得都挺好看的，您觉得呢？
https://github.com/tabler/tabler-icons
28、Mastering_Go_ZH_CN：《Mastering Go》的中文翻译版《玩转 Go》。在线阅读
